"""
Drawn from this post on circular imports: https://medium.com/brexeng/avoiding-circular-imports-in-python-7c35ec8145ed
In this github repo: https://github.com/amenck/circular_import_refactor/blob/test-imports-from-source/objects/tests/_import_from_source.py#L133 
"""
